...
- (BOOL)processFilename:(NSString *)aFilename inVM:(NSMutableDictionary *)vm;
{
    ...
    return [self _processFilename:adjustedPath inVM:vm];
}

// Return YES if successful, NO if there was an error.
- (BOOL)_processFilename:(NSString *)aFilename inVM:(NSMutableDictionary *)vm;
{
    CDFatFile *aFatFile;
	...
	[aProcessor setVirtualMemory:vm];
    [aProcessor process];
...
- (void)appendHeaderToString:(NSMutableString *)resultString;
{
    ...
    [resultString appendString:@" *\n"];
    [resultString appendString:@" *     class-dump is Copyright (C) 1997-1998, 2000-2001, 2004-2005 by Steve Nygard.\n"];
    [resultString appendString:@" */\n\n"];
}
