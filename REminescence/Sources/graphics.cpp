...
void Graphics::drawPoint(uint8 color, const REPoint *pt) {
...
void Graphics::drawLine(uint8 color, const REPoint *pt1, const REPoint *pt2) {
...
void Graphics::drawEllipse(uint8 color, bool hasAlpha, const REPoint *pt, int16 rx, int16 ry) {
...
void Graphics::drawSegment(uint8 color, bool hasAlpha, int16 ys, const REPoint *pts, uint8 numPts) {
...
void Graphics::drawPolygonOutline(uint8 color, const REPoint *pts, uint8 numPts) {
...
void Graphics::drawPolygon(uint8 color, bool hasAlpha, const REPoint *pts, uint8 numPts) {
